  ...
  return (
    <section className="business section" id="business">
      <div className="shell">
        ...
        <div className="business-cta"><p>Planning a repair business, institutional training programme, or consultancy project?</p><a target="_blank" rel="noreferrer" href={whatsappHref(enquiryMessage("repairBusinessSetup"))}>Discuss your project <ArrowRight aria-hidden="true" size={17} /></a></div>
      </div>
    </section>
  );
}
